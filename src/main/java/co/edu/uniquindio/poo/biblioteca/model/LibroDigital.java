...
public class LibroDigital extends Libro {
    ...
    public LibroDigital(String codigo, String titulo, String autor, String genero, String anioPublicacion, EstadoLibro estado, FormatoLibro formato, String enlace) {
